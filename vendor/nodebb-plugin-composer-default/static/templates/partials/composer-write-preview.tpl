<div class="write-preview-container d-flex gap-2 flex-grow-1 overflow-auto">
	<div class="write-container d-flex d-md-flex flex-column gap-2 w-50 position-relative">
		...
		<textarea class="write shadow-none rounded-1 w-100 form-control" rows="12" style="min-height: 14rem;" placeholder="[[modules:composer.textarea.placeholder]]">{body}</textarea>
	</div>
